 ...
 * @since 0.1.0
 */
data class EtcdEndpoint internal constructor(val host: String, val port: Int, val schema: Schema) {
    companion object {
        /**
         ...
         */
        fun ofDetail(host: String, port: Int, schema: Schema = Schema.Http): EtcdEndpoint {
            ...
            return EtcdEndpoint(host.trim(), port, schema)
        }
         ...
         */
        fun of(endpoint: String): EtcdEndpoint {
