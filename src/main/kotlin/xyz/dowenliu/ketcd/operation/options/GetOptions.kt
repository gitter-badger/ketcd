 ...
 *
 * @property limit The maximum number of keys to return for a get request.
 ...
 */
// TODO find out the version the countOnly flag supports.
class GetOptions private constructor(val endKey: ByteString?,
                                     val limit: Long,
                                     val revision: Long,
    ...
    class Builder internal constructor() {
        ...
        fun withLimit(limit: Long): Builder {
            this.limit = limit // TODO checking if it's greater than or equal zero ?
            return this
        }
         ...
         */
        fun build(): GetOptions = GetOptions(endKey, limit, revision, sortOrder, sortTarget, serializable, keysOnly,
                countOnly)
    }
}